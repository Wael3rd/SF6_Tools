...
local last_kb_state = { [0x31]=false, [0x32]=false, [0x33]=false, [0x34]=false, [0x38]=false }

-- VK codes pour les touches 1,2,3,4,8 (haut du clavier)
...
local KB_8 = 0x38  -- A (OPEN COMBO DROPDOWN)
...
local function handle_combo_shortcuts()
    ...
    -- Lecture clavier : touches 1,2,3,4,8 (front-edge)
    local kb_now = {
